...
const board = [
  { name: "Patryk Ostern",    role: "Co-President",       image: "/assets/members/patryk_ostern.jpg" },
  { name: "Adam Pasierski",   role: "Co-President",       image: "/assets/members/adam_pasierski.jpg" },
  { name: "Jakub Tybuski",    role: "Head of FinOps",     image: "/assets/members/jakub_tybuski.png" },
  { name: "Julia Nobis",      role: "Head of Events",     image: "/assets/members/julia_nobis.jpg" },
  { name: "Tomasz Brzezinski",role: "Head of Marketing",  image: "/assets/members/tomasz_brzezinski.jpg" },
];
        ...
        <section className="bg-navy-dark border-t border-white/5 py-24 px-6">
          <div className="max-w-[1400px] mx-auto">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {board.map((member) => (
                <div key={member.name} className="bg-navy rounded-2xl border border-white/10 overflow-hidden">
                  {member.image ? (
